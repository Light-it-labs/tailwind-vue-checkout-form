     ...
     <div class="col-span-1 lg:col-span-6">
      ...
      <div class="p-10 rounded-md shadow-md bg-white">
        ...
        <div class="mb-6">
          ...
          data-card-field
          autocomplete="off" class="border border-gray-500 rounded-md inline-block py-2 px-3 w-full text-gray-600 tracking-wider">
        </div>
        <div class="mb-6">
          ...
          data-card-field
          autocomplete="off" class="border border-gray-500 rounded-md inline-block py-2 px-3 w-full text-gray-600 tracking-widest">
        </div>
        ...
        <div class="mb-6 text-right">
          <span class="text-right font-bold">$359,23</span>
        </div>
        <div>
          <button class="w-full text-ceenter px-4 py-3 bg-blue-500 rounded-md shadow-md text-white font-semibold">Confirm payment</button>
        </div>
       </div>
    </div>
</template>
